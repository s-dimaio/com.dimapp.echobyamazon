...
class TaskScheduler {    /**
     ...
     */
    constructor(homey, task, interval = DEFAULT_VALUES.INTERVAL, showLog = DEFAULT_VALUES.SHOW_LOG, fileLogger = null) {
     ...
     * Also writes to FileLogger if available.
     * @private
     * @param {string} level - Log level (INFO, WARN, ERROR)
     * @param {...any} args - The arguments to log
     */
    _log(level = 'INFO', ...args) {
        if (!this.showLog && !this.fileLogger) return;
        ...
        if (this.fileLogger) {
            ...
            switch (level) {
                case 'ERROR':
                    this.fileLogger.error('TASK-SCHEDULER', message);
                    break;
                case 'WARN':
                    this.fileLogger.warn('TASK-SCHEDULER', message);
                    break;
                default:
                    this.fileLogger.info('TASK-SCHEDULER', message);
            }
        }
    }
