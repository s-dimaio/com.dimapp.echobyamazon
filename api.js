...
// Log file constants
const LOG_FILE = '/userdata/echo_debug.log';
const MAX_BACKUPS = 2;
...
function getLogFileName(index) {
  if (index === 0) {
    return 'echo_debug.log';
  }
  return `echo_debug.log.${index}`;
}
...
module.exports = {
   ...
   * GET /api/app/com.dimapp.echobyamazon/log/status
   * @param {Object} params - The parameters object
   * @param {Object} params.homey - The Homey object
   * @returns {Promise<Object>} Log status object
   */
  async getLogStatus({ homey }) {
    console.log('API - getLogStatus - called');
    ...
    try {
      ...
      console.error('API - getLogStatus - error:', error.message);
   ...
   * GET /api/app/com.dimapp.echobyamazon/log/download/:index
   * @param {Object} params - The parameters object
   * @param {Object} params.homey - The Homey object
   * @param {Object} params.params - Route parameters
   * @returns {Promise<string>} URL string for downloading the file
   */
  async getLogDownloadFile({ homey, params }) {
    console.log('API - getLogDownloadFile - called with index:', params.index);
    ...
    try {
      ...
      const downloadUrl = `http://${localAddress}${API_CONSTANTS.APP_PATH_PREFIX}${filePath}`;
   ...
   * DELETE /api/app/com.dimapp.echobyamazon/log/:index
   * @param {Object} params - The parameters object
   * @param {Object} params.homey - The Homey object
   * @param {Object} params.params - Route parameters
  ...
  async deleteLogFile({ homey, params }) {
    console.log('API - deleteLogFile - called with index:', params.index);
    ...
    try {
      ...
      console.log('API - deleteLogFile - deleted:', fileName);
      return { success: true, deletedFile: fileName };
    } catch (error) {
      console.error('API - deleteLogFile - error:', error.message);
   ...
   * DELETE /api/app/com.dimapp.echobyamazon/log/all
   * @param {Object} params - The parameters object
   * @param {Object} params.homey - The Homey object
   * @returns {Promise<Object>} Result object
   */
  async deleteAllLogs({ homey }) {
    console.log('API - deleteAllLogs - called');
    ...
    try {
      ...
      console.log('API - deleteAllLogs - deleted files:', deletedFiles);
      return { success: true, deletedCount: deleted, deletedFiles: deletedFiles };
    } catch (error) {
      console.error('API - deleteAllLogs - error:', error.message);
      return { success: false, error: error.message };
    }
  }
};